    ...
    return (
        <footer className="site-footer" id="footer">
            ...
            <div className="container">
                ...
                {/* Copyright Bar */}
                <div className="footer-bottom" role="contentinfo" aria-label="Footer bottom">
                    <p className="footer-copyright">
                        © {new Date().getFullYear()} <strong>College Lover</strong>. Built
                        with <FaHeart className="heart-icon" aria-hidden="true" /> for ITER
                        students.
                    </p>

                    <p className="footer-tech">
                        Crafted with <strong>Love</strong> •{' '}
                        <span className="footer-tech-stack">React + Vite</span>
                    </p>
                </div>
            </div>
        </footer>
